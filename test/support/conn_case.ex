defmodule SupacWeb.ConnCase do
  @moduledoc """
  ...
  by setting `use SupacWeb.ConnCase, async: true`, although
  ...
  using do
    quote do
      ...
      import SupacWeb.ConnCase

      alias SupacWeb.Router.Helpers, as: Routes

      # The default endpoint for testing
      @endpoint SupacWeb.Endpoint
    end
  end

  setup tags do
    pid = Ecto.Adapters.SQL.Sandbox.start_owner!(Supac.Repo, shared: not tags[:async])
  ...
  def register_and_log_in_user(%{conn: conn}) do
    user = Supac.AccountsFixtures.user_fixture()
  ...
  def log_in_user(conn, user) do
    token = Supac.Accounts.generate_user_session_token(user)
