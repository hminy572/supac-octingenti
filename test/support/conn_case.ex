defmodule Lv13Web.ConnCase do
  ...
  by setting `use Lv13Web.ConnCase, async: true`, although
  ...
  using do
    quote do
      ...
      import Lv13Web.ConnCase

      alias Lv13Web.Router.Helpers, as: Routes

      # The default endpoint for testing
      @endpoint Lv13Web.Endpoint
    end
  end

  setup tags do
    pid = Ecto.Adapters.SQL.Sandbox.start_owner!(Lv13.Repo, shared: not tags[:async])
  ...
  def register_and_log_in_user(%{conn: conn}) do
    user = Lv13.AccountsFixtures.user_fixture()
  ...
  def log_in_user(conn, user) do
    token = Lv13.Accounts.generate_user_session_token(user)
